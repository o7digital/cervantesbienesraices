...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "bienes raíces de lujo CDMX",
    "inmobiliaria premium Ciudad de México",
    "asesoría inmobiliaria profesional CDMX",
    "venta de propiedades premium CDMX",
    "compra de propiedades premium CDMX",
    "propiedades exclusivas en CDMX",
