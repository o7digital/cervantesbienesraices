            ...
            <div className="row align-items-center">
               <div className="col-lg-6 d-flex">
                  <div className="pe-xxl-5 me-xl-4 pt-100 xl-pt-80 pb-45 w-100 h-100 wow fadeInLeft">
                     ...
                     <div className="fs-16 mt-20 opacity-75">*Ответ в течение 24 часов</div>
                  </div>
               </div>
               ...
               <div className="col-lg-6 d-flex">
                  <div className="w-100 h-100 ms-lg-5 wow fadeInRight d-flex flex-column align-items-center justify-content-start pt-100 xl-pt-80">
                     ...
                     <div className="text-center mt-4">
                        <h3 className="mb-3">Финансирование</h3>
                        <h4 className="color-dark mb-2">Для вашего следующего дома</h4>
                        <p className="fs-18 opacity-75">Конкурентные ставки и персональная консультация</p>
                     </div>
                  </div>
               </div>
            </div>
...
export default MortgageCreditRu
