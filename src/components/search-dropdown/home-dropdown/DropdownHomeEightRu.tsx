...
const DropdownHomeEightRu = () => {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    const href = `/ru/listing_06?${params.toString()}`;
      ...
      <div className="row gx-0 align-items-center">
        <div className="col-xl-3 col-lg-4">
          <div className="input-box-one border-left">
            <div className="label">Я хочу</div>
            <NiceSelect
              className="nice-select fw-normal"
              options={[
                { value: "buy_apartment", text: "Купить квартиру" },
                { value: "buy_house", text: "Купить дом" },
                { value: "rent_apartment", text: "Арендовать квартиру" },
                { value: "rent_house", text: "Арендовать дом" },
              ]}
              defaultCurrent={0}
              onChange={handleType}
              name="type"
        ...
        <div className="col-xl-3 col-lg-4">
          <div className="input-box-one border-left">
            ...
            <NiceSelect
              ...
              options={[
                { value: "cdmx", text: "Мехико, Мексика" },
        ...
        <div className="col-xl-3 col-lg-4">
          <div className="input-box-one border-left border-lg-0">
            <div className="label">Диапазон цены</div>
            <NiceSelect
              className="nice-select fw-normal"
              options={[
        ...
        <div className="col-xl-3">
          <div className="input-box-one lg-mt-10">
            <button className="fw-500 tran3s w-100 search-btn-three">Найти</button>
          </div>
        </div>
      </div>
    </form>
...
export default DropdownHomeEightRu;
